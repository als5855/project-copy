...
public class GetResponseRecommendationDto {
    ...
    public GetResponseRecommendationDto(Recommendation recommendation) {
        this.groupId = recommendation.getId().getGroupId();
        this.userId = recommendation.getId().getUserId();
        this.groupTitle = recommendation.getMeetingGroup().getGroupTitle();
        this.groupContent = recommendation.getMeetingGroup().getGroupContent();
        this.groupAddress = recommendation.getMeetingGroup().getGroupAddress();
        this.groupImage = recommendation.getMeetingGroup().getGroupImage();
        this.groupSupplies = recommendation.getMeetingGroup().getGroupSupplies();
        this.groupDate = recommendation.getMeetingGroup().getGroupDate();
        this.groupCategory = recommendation.getMeetingGroup().getGroupCategory();
        this.groupType = recommendation.getMeetingGroup().getGroupType();
        this.meetingType = recommendation.getMeetingGroup().getMeetingType();
    }
